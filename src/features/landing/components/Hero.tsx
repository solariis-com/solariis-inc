          ...
          <div className="space-y-8">
            ...
            <div className="pt-4 space-y-4">
              <button
                ...
                className="inline-flex items-center bg-text text-white px-8 py-4 text-lg font-medium hover:bg-text/90 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="block text-text-light hover:text-text transition-colors duration-200 text-base underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm"
