        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20 relative z-10">
            ...
            <div className="bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="w-16 h-16 mx-auto mb-8 relative flex items-center justify-center">
                <svg width="40" height="40" viewBox="0 0 48 48" className="text-primary">
                  <path
            ...
            <div className="bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="w-16 h-16 mx-auto mb-8 relative flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="absolute right-0 top-0 w-0 h-0 border-l-3 border-l-primary border-t-2 border-b-2 border-t-transparent border-b-transparent"></div>
